...
function login() {
    ...
    document.write('<div class="nri"><a id="translatelink" href="javascript:translatePage();" title="点击[繁/简]切换">繁体版</a></div></div></div>');
}
...
function read_panel() {
    showsearch();
    document.writeln("<a href='https://oscms.win' target='_blank'><div class=\"userpanel\">导航站<br>https://oscms.win</div></a>");
}
