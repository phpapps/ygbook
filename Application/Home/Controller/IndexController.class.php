...
class IndexController extends BaseController
{
    public function index()
    {
        ...
        $xzv_23 = array('weburl' => C('NOWHOST') . C('HOME_URL'), 'canonicalurl' => C('NOWHOST') . C('HOME_URL'), 'canonicalurl_m' => C('WAPHOST') . C('HOME_URL'), 'webname' => $this->setting['seo']['webname'], 'title' => $this->setting['seo']['indextitle'], 'keyword' => $this->setting['seo']['indexkw'], 'description' => $this->setting['seo']['indexdes'], 'flink' => $xzv_123);
